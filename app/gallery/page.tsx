...
const galleryImages = [
  ...
  { src: '/images/poke-bowl.jpg', alt: 'Fresh poke bowl with tuna and avocado', category: 'Poke' },
  { src: '/images/burger.jpg', alt: 'aLMIGHTY Kona Melt burger', category: 'Mains' },
  { src: '/images/sandwich.jpg', alt: 'Signature sandwich with fries', category: 'Mains' },
  { src: '/images/dish-1.jpg', alt: 'Signature dish 1', category: 'Signatures' },
  { src: '/images/dish-2.jpg', alt: 'Signature dish 2', category: 'Signatures' },
  { src: '/images/dish-3.jpg', alt: 'Fresh ingredients', category: 'Signatures' },
  { src: '/images/dish-4.jpg', alt: 'Plated entree', category: 'Mains' },
  { src: '/images/dish-5.jpg', alt: 'Chef special', category: 'Signatures' },
  { src: '/images/dish-6.jpg', alt: 'Tropical flavors', category: 'Signatures' },
  { src: '/images/dish-7.jpg', alt: 'Fresh prepared dish', category: 'Mains' },
  { src: '/images/dish-8.jpg', alt: 'Island fusion creation', category: 'Signatures' },
  { src: '/images/dish-9.jpg', alt: 'House specialty', category: 'Mains' },
  { src: '/images/dish-10.jpg', alt: 'Colorful presentation', category: 'Signatures' },
  { src: '/images/dish-11.jpg', alt: 'Artisan plating', category: 'Mains' },
  { src: '/images/dish-12.jpg', alt: 'Fresh seasonal dish', category: 'Signatures' },
  { src: '/images/dish-main.jpg', alt: 'Featured main course', category: 'Mains' },
];
